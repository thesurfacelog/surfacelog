...
function LeaderList({
  ...
  return (
    <div className="border border-green-700/40 rounded-lg p-3">
      <div className="text-xs text-green-200/70 mb-2">{title}</div>

      {rows.length === 0 ? (
        <div className="text-[11px] text-green-200/50">no data yet</div>
      ) : (
        <ol className="text-sm">
          {rows.slice(0, 5).map((r, idx) => (
            ...
            >
              ...
              <span className="text-green-200/80">{rightValue(r)}</span>
            </li>
          ))}
        </ol>
      )}
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
          ...
          <section className="border border-green-700/40 rounded-lg p-4">
            ...
            {logs.length === 0 ? (
              <div className="text-sm text-green-200/60">no transmissions yet</div>
            ) : (
          ...
          <aside className="border border-green-700/40 rounded-lg p-4">
            <div className="flex items-center justify-between mb-3">
              <div className="text-sm text-green-200/80">Speranza Watchlist</div>
              <button
            ...
            <div className="grid gap-3">
              ...
              <div className="text-[11px] text-green-200/50">
        ...
        {status ? (
          <div className="mt-6 text-xs text-green-200/70">{status}</div>
        ) : null}
      </div>
    </main>
  );
